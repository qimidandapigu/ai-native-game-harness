...
{
    /// <summary>
    /// 五个固定条目是技能教学与成长事件，并借用原版 Quest Log 展示进度。
    /// 它不选择、推进或保存 Harness 主剧情。
    /// </summary>
    internal sealed class QuestService
    {
        ...
        public void TryOfferWateringLesson()
        {
            ...
            this.monitor.Log("[成长] 已发布浇水技能教学", LogLevel.Info);
        }
        ...
        public void TryOfferHarvestLesson()
        {
            ...
            this.monitor.Log("[成长] 已发布收割技能教学", LogLevel.Info);
        }
        ...
        public void TryOfferFishingLesson()
        {
            ...
            this.monitor.Log("[成长] 已发布钓鱼技能教学", LogLevel.Info);
        }
        ...
        public void TryOfferCombatLesson()
        {
            ...
            this.monitor.Log("[成长] 已发布战斗技能教学", LogLevel.Info);
        }
        ...
        public void TryOfferRescueLesson()
        {
            ...
            this.monitor.Log("[成长] 已发布救援技能教学", LogLevel.Info);
        }
        ...
        public void CompleteFishingLesson()
        {
            this.CompleteAbilityLesson(
                ...
                quest => this.ApplyAbilityReward(
                    ...
                    "[成长] 豆包通过浮标练习学会了在请求后帮农夫完成下一次钓鱼收杆。",
        ...
        public void CompleteRescueLesson()
        {
            this.CompleteAbilityLesson(
                ...
                quest => this.ApplyAbilityReward(
                    ...
                    "[成长] 豆包通过深夜回家练习记住了农夫的回家路线,学会了紧急送农夫回床。",
        ...
        private void ApplyWateringReward(QuestInstance quest)
        {
            ...
            this.recordBond(+2, "[成长] 豆包通过浇水练习学会了在请求后帮农夫批量浇水。");
