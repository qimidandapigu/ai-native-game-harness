...
/// <summary>
/// 陪伴生活系统的深 Module：封装关系、心情、怪癖、仪式、心愿、日记与叙事存档。
...
internal sealed class CompanionLifeModule
{
    ...
    private readonly NarrativeState narrative;
    ...
    public void OnSaveLoaded(string saveIdentity)
    {
        ...
        loaded.Narrative ??= new NarrativeState();
        this.data = loaded;
        this.narrative.CopyFrom(loaded.Narrative);
        this.data.Narrative = this.narrative;
    ...
    public void Reset()
    {
        ...
        this.narrative.CopyFrom(new NarrativeState());
    ...
    public void NoteConversation(string text)
    {
        ...
        this.narrative.RelationshipPoints = Math.Max(0, this.narrative.RelationshipPoints + 1);
    ...
    public void RecordBond(int moodDelta, string eventText)
    {
        ...
        this.narrative.RelationshipPoints = Math.Max(0, this.narrative.RelationshipPoints + relationshipDelta);
        ...
        this.presentation.Present(new PresentationEvent(
            ...
            {
                ["mood"] = this.data.Mood,
                ["relationshipPoints"] = this.narrative.RelationshipPoints,
            }));
    }
    ...
    {
        int daysTogether = this.DaysTogether();
        QuestInstance? active = this.narrative.Quests.FirstOrDefault(quest => quest.State == QuestLifecycleState.Active);
        CompanionWishState? wish = this.data.Daily.Wish;
        return new CompanionLifeSnapshot(
            this.data.Mood,
            MoodLabel(this.data.Mood),
            this.narrative.RelationshipPoints,
    ...
    private void RecordEvent(string text)
    {
        ...
        this.narrative.AddSemanticEvent(text);
    }
